 ...
 <nav class="navbar navbar-dark bg-primary navbar-expand-sm fixed-top">
	<div class="container">
	  	<a class="navbar-brand" href="${pageContext.request.contextPath }/">
	  		<img style="width:30px;height:30px" src="${pageContext.request.contextPath }/images/ryan.jpg"/> 
	  	</a>
		...
		<div class="collapse navbar-collapse" id="topNav">
			...
			<%if(id==null){ %>
				...
				href="${pageContext.request.contextPath }/user/joinform.jsp">회원가입</a>
			<%}else{ %>
				<span class="navbar-text">
					<a href="${pageContext.request.contextPath }/user/private/info.jsp"><%=id %></a>
					<a class="btn btn-warning btn-sm" href="${pageContext.request.contextPath }/user/logout.jsp">로그아웃</a>
				</span>
			<%} %>	
		</div>
	</div>
